 ...
 *  3. Rate limiting sur /api/contact, /api/newsletter et /api/afrinomade/demandes (5 ou 3 req/15min par IP)
...
export async function proxy(req: NextRequest) {
  ...
  if (pathname === "/api/contact" || pathname === "/api/newsletter" || pathname === "/api/afrinomade/demandes") {
    maybeClean(publicStore, 15 * 60_000);
    const maxReqs = (pathname === "/api/newsletter" || pathname === "/api/afrinomade/demandes") ? 3 : 5;
